...
<script>
  ...
  <div class="products">
    <div class="product-card" id="product1">
      <img class="product-image" src="admin_area/images/05f053ae21f06a0333470e18e4b962cd3344cad6.jpg" alt="Product 1">
      <div class="product-title">Tops</div>
      <button class="view-button" id="viewTopsButton" name="viewTopsButton"><a href="womensdisplay.php?tops">view</a></button>
    </div>
    <div class="product-card" id="product4">
      <img class="product-image" src="admin_area/images/8c70be5d9bea36e0616e703251e44627-5986335432_1_1_0.jpg" alt="Product 4">
      <div class="product-title">Denims</div>
      <button class="view-button" id="viewDenimButton" name="viewDenimButton"><a href="womensdisplay.php?denim">view</a></button>

    </div>
    <div class="product-card" id="product5">
      <video autoplay muted loop >
        <source src="admin_area/images/untitled.mp4" type="video/mp4">
          Your browser does not support the video tag.
        </video>
      <div class="product-title">Hoodies</div>
      <button class="view-button" id="viewHoodiesButton" name="viewHoodiesButton"><a href="womensdisplay.php?hoodies">view</a></button>
    </div>
