...
if (isset($_GET['shirts'])) {
    // Code for displaying Tops products
    global $conn;
    $select_tops = "SELECT * FROM `products` WHERE category_id = 28";
    $result_tops = mysqli_query($conn, $select_tops);

    displayProducts($result_tops);

} elseif (isset($_GET['bottoms'])) {
    // Code for displaying denim products
    global $conn;
    $select_bottoms = "SELECT * FROM `products` WHERE category_id = 29";
    ...
    global $conn;
    $select_hoodies = "SELECT * FROM `products` WHERE category_id = 30";
